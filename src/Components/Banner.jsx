    ...
    <div className="relative w-full max-w-7xl mx-auto my-12 px-4">
      <div className="relative rounded-3xl shadow-2xl overflow-hidden group">
        ...
        <div className="absolute inset-0 rounded-3xl p-0.75 pointer-events-none">
          <div className="absolute inset-0 rounded-3xl bg-linear-to-r from-green-400 via-emerald-500 to-green-400 animate-[spin_3s_linear_infinite] opacity-80"></div>
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start mb-4 lg:mb-6 gap-4">
                ...
                <div>
                  ...
                  {/* Rating stars aligned under the title */}
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                ...
                <button
                  ...
                  className="group relative lg:whitespace-nowrap bg-linear-to-r from-green-500 to-emerald-300 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base"
                >
                ...
                {/* Emergency Button */}
                <button
                  onClick={() => (window.location.href = "tel:8292196144")}
